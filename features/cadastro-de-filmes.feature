...
Funcionalidade: Cadastro de filmes
    ...
    Esquema do Cenario: Campos obrigatórios
        O gestor de catálogo cadastra um novo filme, mas esquece
    ...
    Cenario: Duplicado
        ...
        já foi cadastrado em outro momento e o sistema notifica o
        usuário, informando que o título já existe.
